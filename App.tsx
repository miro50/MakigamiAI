  ...
  const { error } = await supabase
    ...
    .insert([
      { 
        ...
        process_name: processData.meta_analysis.process_name,
        ...
        <div className="p-6">
          ...
          <div className="mt-4 flex justify-between items-center flex-wrap gap-4">
            ...
            >
              {isGenerating ? (
                <>
                  <Sparkles className="w-5 h-5 animate-spin" /> Analisi in corso...
                </>
              ) : (
                <>
                  <Search className="w-5 h-5" /> Analizza & Crea Mappa
                </>
              )}
            </button>
          </div>
        ...
        <div className="flex justify-between items-center mb-6">
           <button 
            ...
            >
              ...
              {viewState === 'compare' ? 'Torna alla Mappa' : 'Torna ai Parametri'}
            </button>
           ...
           {viewState === 'visualize' && (
             <div className="flex items-center gap-3">
               ...
               >
                 ...
                 {saveSuccess ? 'Salvato!' : 'Salva Processo'}
               </button>
               ...
               >
                 ...
                 {isOptimizing ? 'Generazione...' : 'Genera "To-Be"'}
               </button>
             </div>
           )}
        </div>
